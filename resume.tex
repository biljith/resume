...
{\customcvproject{Smart Helmet}{Aug 2016 – Dec 2016}
{\begin{itemize}
  \item This solution was meant to go on the helmet, giving the user access to frequently used actions on his phone (like call, music, etc.) without having to take his phone out. This project won the first prize at 'Nipun' -  a competition held in Samsung Research Institute, Bangalore (SRI-B)
\end{itemize}
}
...
\begin{minipage}{\maincolumnwidth}%
	\small{
    	\begin{itemize}
    	  ...
    	  \item Received Employee of the Month award recognizing my contributions to the project.
    	  \item Won 'Ultimate Coder', an intercollegiate competition that focused on using algorithms to solve problems.
    	  \item Won the Nipun demo award for Smart Helmet project.
    	  \item Contributed patches to open source Chromium project.
    	  \item Won the best team award for contributions to SAT.
